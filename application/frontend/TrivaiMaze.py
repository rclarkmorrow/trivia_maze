...
class TriviaMaze:
    ...
    def game_starter():
        ...
        dungeon = Maze(column_count, row_count)
        ...
        while True:
            ...
            if TriviaMaze.if_passable(dungeon, curr_x, curr_y, next_x, next_y, column_count, row_count):
    ...
    @staticmethod
    def if_passable(dungeon: Maze, curr_x: int, curr_y: int, next_x: int, next_y: int, column_count: int,
                    row_count: int):
        """
